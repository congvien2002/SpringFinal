			            			...
			            			<tr>
			            			 ...
			            			 <c:forEach items="${lstA}" var="a">
					           			...
					           			<tr>
					            			...
					            			<th><button class="btn btn-primary"><a style="color:#fff" href="${rootpath}answer/init-update/${a.id}"><spt:message code="app.label.update" /></a></button></th>
					            			<th><button class="btn btn-primary"><a style="color:#fff" href="${rootpath}answer/delete/${a.id}"><spt:message code="app.label.delete" /></a></button></th>
					            		</tr>
					            	</c:if>
					            </c:forEach>
			            		</table>
					            <button class="btn btn-warning"><a href="${rootpath}answer/init-insert/${ques.id}"><spt:message code="app.label.insert" /></a></button>
			            	</div>
			            </div>
